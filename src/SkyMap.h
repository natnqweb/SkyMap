...
//this library is powerfull tool created by me to calculate star position of any star
...
// actuall speed of calculations measured in UNO R3 is 1400 [us] [micro seconds]
...
public:
    ...
    float Hh_mm_ss2UTC(unsigned int hhh, unsigned int mmm, unsigned int sss, unsigned int your_timezone_offset); //calculate utc from your local time
    ...
    void Calculate_all();                                                                  //this function is avaliable only if you provide all data at constructor! returns true on success false on failure! indicating that you probably didn't provided all data at construction
